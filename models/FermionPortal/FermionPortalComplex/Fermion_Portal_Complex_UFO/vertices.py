...
V_6 = Vertex(name = 'V_6',
             particles = [ P.Qd__tilde__, P.d, P.chi__tilde__ ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFS1 ],
             couplings = {(0,0):C.GC_10})

V_7 = Vertex(name = 'V_7',
             particles = [ P.Qu__tilde__, P.u, P.chi__tilde__ ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFS1 ],
             couplings = {(0,0):C.GC_11})

V_8 = Vertex(name = 'V_8',
             particles = [ P.d__tilde__, P.Qd, P.chi ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFS2 ],
             couplings = {(0,0):C.GC_10})

V_9 = Vertex(name = 'V_9',
             particles = [ P.u__tilde__, P.Qu, P.chi ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFS2 ],
             couplings = {(0,0):C.GC_11})
