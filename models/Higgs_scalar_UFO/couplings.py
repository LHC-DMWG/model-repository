...
GC_23 = Coupling(name = 'GC_23',
                 value = 'complex(0,1)*G**2*GS',
                 order = {'HIG':1,'QCD':2})

GC_24 = Coupling(name = 'GC_24',
                 value = '-(complex(0,1)*GSH)',
                 order = {'HIG':2})
...
GC_99 = Coupling(name = 'GC_99',
                 value = '(-4*complex(0,1)*MH**2*sp)/vev - (2*complex(0,1)*MSc**2*sp)/vev',
                 order = {'QED':1})
...
GC_131 = Coupling(name = 'GC_131',
                  value = '(complex(0,1)*sp*ymb*cmath.sqrt(2))/vev',
                  order = {'QED':1})

GC_132 = Coupling(name = 'GC_132',
                  value = '(complex(0,1)*sp*ymc*cmath.sqrt(2))/vev',
                  order = {'QED':1})

GC_133 = Coupling(name = 'GC_133',
                  value = '(complex(0,1)*sp*ymdo*cmath.sqrt(2))/vev',
                  order = {'QED':1})

GC_134 = Coupling(name = 'GC_134',
                  value = '(complex(0,1)*sp*yms*cmath.sqrt(2))/vev',
                  order = {'QED':1})

GC_135 = Coupling(name = 'GC_135',
                  value = '(complex(0,1)*sp*ymt*cmath.sqrt(2))/vev',
                  order = {'QED':1})

GC_136 = Coupling(name = 'GC_136',
                  value = '(complex(0,1)*sp*ymup*cmath.sqrt(2))/vev',
                  order = {'QED':1})
